...
#include <inttypes.h>
#include <time.h>
#include "../src/numkey/countrykey.h"

static const int k_countrykey_test_size = 676;

typedef struct test_countrykey_data_t
{
    const char* country;
    uint16_t    ck;
} test_countrykey_data_t;

static const test_countrykey_data_t test_countrykey_data[] =
{
    {"AA", 16705},
    {"AB", 16706},
    {"AC", 16707},
...
int main()
{
    ...
    errors += test_decode_countrykey();

    benchmark_countrykey();
    benchmark_decode_countrykey();
